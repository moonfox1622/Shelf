...
namespace Shelf
{
    public partial class SettingForm : Form
    {
        ...
        private void SettingShown(object sender, EventArgs e)
        {
            ...
            InfoUserControl info = new InfoUserControl { name = this.name };
        ...
        {
            settingPanel.Controls.Clear();
            ChangeUserControl change = new ChangeUserControl { name = this.name };
        ...
        {
            settingPanel.Controls.Clear();
            EditUserControl edit = new EditUserControl { name = this.name };
